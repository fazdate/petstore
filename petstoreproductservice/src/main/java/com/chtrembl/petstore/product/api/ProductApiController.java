...
public class ProductApiController implements ProductApi {
	...
	public ProductApiController(ObjectMapper objectMapper, NativeWebRequest request, ProductRepository productRepository) {
	...
	public ResponseEntity<List<Product>> findProductsByStatus(
		...
		if (acceptType != null && contentType != null && acceptType.contains("application/json")
			...
			ProductApiController.log.info(String.format(
					...
					status));
			try {
				String petsJSON = new ObjectMapper().writeValueAsString(this.getPreloadedProducts(productRepository));
